...
| 8 | Média | Como Administrador, eu quero ter acesso a um dashboard centralizado, para que eu possa visualizar de forma clara e rápida as informações mais relevantes sobre os projetos. | 6 | 4 | Dashboard contendo as informações da situação de todos os projetos |
