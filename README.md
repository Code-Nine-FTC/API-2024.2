...
| 14 | Média | Como Administrador, eu quero transformar as informações do Dashboard em arquivos no formato do PDF e/ou Excel, para que eu possa compartilhar, armazenar e analisar os dados de maneira eficiente e compatível com outras ferramentas. | 5 | 1 | Na página do Dashboard o Administrador pode baixar um Arquivo Excel ou PDF do gráfico | 4 |
| 15 | Alta | Como Administrador, eu quero adicionar o cadastro de Convênios para que consiga avaliar melhor as normas de cada projeto. | 5 | 6 | Os convênios deverão possuir uma interface para cadastra-los e podem ser linkados aos projetos | 4 |
| 16 | Alta | Como Administrador, eu quero cadastrar Bolsistas e lista-los em uma interface. | 5 | 2 | O cadastro deverá ter todos os dados do Bolsista, a área de Atuação, o tipo de bolsa e duração. | 4 |
| 17 | Alta | Como Administrador, eu quero cadastrar Parceiros para que possa visualiza-los e realizar o registro dos mesmos nas receitas dos projetos. | 5 | 2 | Deverá ter um cadastro de todos os parceiros podem ou não serem linkados aos projetos | 4 |
